          ...
          for (key in jsonResponse) {
            ...
            //for (var i = 0; i < fields.length; i++) {
              ...
              */
              ...
              td.innerHTML = `<div class="w3-hover-text-green" onclick='editData (`+BPTypeID.STRING+`, "`+key+`")' style="cursor:pointer;" title="Edit value">`+(typeof value === 'object' ? JSON.stringify(value, null, 2) : value)+`</div>`;
